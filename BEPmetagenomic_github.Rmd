...
alpha_div_extended <- merge(
  x=alpha_div,
  y=metadata_full[, c("treatment1_prenatal_n", "m_heightincl", "m_hbincl", "w_school_level", "w_marital", "asset1comp_10", "w_language", "w_religion", "w_etnicity", "w_nr_jobs", "csps_n", "w_age", "m_bmiincl", "mddw_10_ave", "ch_sex", "iycf_ebf_age")],
  by=0
  )
